...
public class JannahQuotesPage extends AppCompatActivity {
    ...
    private String JannahQuotes[] = {
            ...
            "They will recline (with ease) on thrones (of dignity) arranged in ranks... (52:20)",  // 10
            ...
            "Eat and drink at ease for that which you have sent forth (good deeds) in days past!” (69:24)", // 15
